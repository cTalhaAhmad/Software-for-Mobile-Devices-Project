...
public class PraticipantSignInMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_praticipant_sign_in_main);
    ...
    public void participant_signin(View view) {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DataSnapshot> task) {
                            if (task.getResult().getValue() != null) {
                                ...
                                String event = passHash.get("event");
                                String subEvent = passHash.get("subevent");
