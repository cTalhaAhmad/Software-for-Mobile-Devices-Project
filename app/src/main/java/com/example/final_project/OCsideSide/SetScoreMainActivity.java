...
public class SetScoreMainActivity extends AppCompatActivity {
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("Add Winner of Sub-Events: " + subevent);
    }

    public void set_winner(View view) {
        if (!editTextSubEvent.getText().toString().isEmpty()) {
            reference.child(event).child(subevent).child("winner")
