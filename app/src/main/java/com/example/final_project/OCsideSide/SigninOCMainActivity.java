...
public class SigninOCMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signin_ocmain);
    ...
    public void OC_signin(View view) {
                        ...
                        public void onComplete(@NonNull Task<DataSnapshot> task) {
                            if (task.getResult().getValue() != null) {
                                ...
                                if (pass.equals(editTextPass.getText().toString())) {
                                    ...
                                    Intent intent = new Intent(context, OCportalMainActivity.class);
                                    intent.putExtra("oc", editTextName.getText().toString());
