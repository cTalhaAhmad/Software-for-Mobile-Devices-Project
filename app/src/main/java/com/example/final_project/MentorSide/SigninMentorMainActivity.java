...
public class SigninMentorMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signin_mentor_main);
    ...
    public void mentor_signin(View view) {
        ...
        reference.child(editTextName.getText().toString())
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                ...
                if (pass.equals(editTextPass.getText().toString())){
                    ...
                    Intent intent=new Intent(context,MentorPortalActivity.class);
                    intent.putExtra("mentor",editTextName.getText().toString());
